...
export default function PartnerSignupForm() {
  ...
  const {name, email, password, errors } = currentValue
  ...
  return (
    <div>
      <div className="form-container">
        <form onSubmit={handleSubmit} className="Login-form partner">
          <div>
          ...
          <a href="#">Already Signed Up ? Please Login Here</a>
        </form>
      </div>
